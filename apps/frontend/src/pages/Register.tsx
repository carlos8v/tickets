...
export const Register = () => {
  ...
  return (
    <div className="px-4 bg-gray-100 h-screen grid place-items-center text-center sm:px-0">
      <form className="w-full max-w-sm mx-auto flex flex-col" onSubmit={handleSubmit}>
        <h1 className="text-2xl mb-8 font-medium">Criar conta</h1>
        <input
          type="text"
          id="name"
          name="name"
        ...
        <button className="mt-6 py-2 text-white bg-blue-600 rounded hover:bg-blue-500 transition" type="submit">
          Criar
        </button>
        <a
